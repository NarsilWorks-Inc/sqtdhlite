...
func (h *SQLiteHelper) Query(querySql string, args ...interface{}) (dhl.Rows, error) {
	var (
		sqr *sql.Rows
	)
	if h.err != nil {
...
func (h *SQLiteHelper) QueryArray(querySql string, out interface{}, args ...interface{}) error {
...
func (h *SQLiteHelper) QueryRow(querySql string, args ...interface{}) dhl.Row {
	if h.err != nil {
		return nil
	}
	if h.conn == nil {
...
func (h *SQLiteHelper) Exec(querySql string, args ...interface{}) (int64, error) {
...
func (h *SQLiteHelper) Exists(sqlWithParams string, args ...interface{}) (bool, error) {
...
func (h *SQLiteHelper) VerifyWithin(tableName string, values []dhl.VerifyExpression) (Valid bool, Error error) {
	...
	sql = `SELECT EXISTS(SELECT 1 FROM ` + tableNameWithParameters + ` LIMIT 1);`
